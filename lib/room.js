...
Room.prototype.moveUserForward = function(user) {
    ...
    user.emit('move forward', currentMedia, this.currentTime + secondsForward);
    console.log('sended user forward');

    var self = this;
    setTimeout(function() {
      console.log('this.currentMedia:' + self.currentMedia);
      console.log('currentMedia:' + currentMedia);
      if (currentMedia == self.currentMedia) {
        user.emit('play now');
      }
